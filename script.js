...
const fetchTodos = () => {
    ...
    {
        return `
        <div class="border-4 flex justify-between bg-white p-4 text-center items-center justify-center rounded-md m-4"><b>${todo.title}</b> 
            <div class="flex ">
...
swal({
    title: "Are you sure?",
    text: "Once deleted, you can't undo!",
    icon: "warning",
    buttons: true,
    dangerMode: true,
  })
